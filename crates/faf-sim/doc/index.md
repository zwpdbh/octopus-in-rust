...
- **Training:** Online per-step REINFORCE with masked softmax and a minimal mass-income reward.
...
6. **[Reward shaping](05-reward-shaping.md)** — A deliberately minimal mass-income-delta reward; terminal bonuses, milestones, and timeout penalties are removed for the baseline.
7. **[Training with REINFORCE](06-training-pipeline.md)** — Greedy episode rollouts, online per-step policy-gradient updates, and masked log-probabilities.
