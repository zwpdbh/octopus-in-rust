...
impl Units {
    ...
    /// Build a dependency tree from the ACU to the requested unit.
    ///
    /// The tree is generated by backward chaining through STRIPS operators.
    /// It is a single satisfiable plan tree, not an exhaustive AND-OR graph.
