...
//!
//! This crate wraps raw `f64` values in domain-specific newtypes so that mass,
//! energy, time, build power, and their rates cannot be accidentally mixed at
//! compile time. It is intentionally tiny and dependency-light so it can be used
//! by the simulator, scheduler, predictor, backend, and frontend alike.
