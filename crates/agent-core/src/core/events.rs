...
#[derive(Clone)]
pub struct ProviderRefreshSender(pub UnboundedSender<Arc<dyn llm_provider::ChatProvider>>);
...
pub enum BrainEvent {
    ...
    Usage { usage: llm_provider::TokenUsage },
    ...
    StatusUpdate {
        ...
        token_usage: Option<llm_provider::TokenUsage>,
