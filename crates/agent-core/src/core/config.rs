...
pub struct BrainConfig {
    ...
    pub provider: Option<Arc<dyn llm_provider::ChatProvider>>,
    ...
    pub toolset: Option<Arc<dyn llm_provider::Toolset>>,
...
impl BrainConfig {
    ...
    pub async fn build_provider(&self) -> Result<Arc<dyn llm_provider::ChatProvider>, BrainError> {
