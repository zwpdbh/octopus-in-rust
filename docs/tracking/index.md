...
|------------|---------|--------|
| Agent-core crate extraction & QQ integration | [`agent-core/index.md`](agent-core/index.md) | ✅ Phase 2 (octopus-cli consumer) and Phase 3 (qqbot-core integration) complete; Phase 4 (config/auth unification) next |
